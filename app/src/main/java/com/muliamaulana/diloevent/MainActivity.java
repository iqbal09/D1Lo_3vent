...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pindahFragment.replace(R.id.content_main,new EventFragment());
        pindahFragment.commit();
//
...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_event) {
            ...
            fragmentManager.beginTransaction().replace(R.id.content_main, eventFragment,eventFragment.getTag()).commit();
